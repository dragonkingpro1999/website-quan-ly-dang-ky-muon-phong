...
@section('content_admin')
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cập nhật thiết bị</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home_admin') }}">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="{{ route('device') }}">Tất cả thiết bị</a></li>
                <li class="breadcrumb-item active" aria-current="page">Cập nhật thiết bị</li>
            </ol>
        </div>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Cập nhật thiết bị</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_device') }}" id="form-edit-device">
                            @csrf
