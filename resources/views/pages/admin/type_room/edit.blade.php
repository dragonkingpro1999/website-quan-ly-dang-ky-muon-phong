...
@section('content_admin')
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cập nhật loại phòng</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home_admin') }}">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="{{ route('type_room') }}">Tất cả loại phòng</a></li>
                <li class="breadcrumb-item active" aria-current="page">Cập nhật loại phòng</li>
            </ol>
        </div>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Cập nhật loại phòng</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_type_room') }}" id="form-edit-type-room">
                            @csrf
