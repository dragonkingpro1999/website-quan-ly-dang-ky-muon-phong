...
class ReportExport_Danh_Sach_Muon_Phong_Success implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        $excel = Session::get('excel_borrow_room_success');
        // dd($excel);
        $report[] = array(
            'STT',
            'Người mượn',
        ...
        foreach ($excel as $key => $value) {
            ...
            $report[$key++] = array(
                ...
                'Phản hồi' => $value->feed_back ? $value->feed_back->noi_dung : '',
                'Tổng TG' => $time,
            );
        }
