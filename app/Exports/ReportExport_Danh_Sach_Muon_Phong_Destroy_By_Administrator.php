...
class ReportExport_Danh_Sach_Muon_Phong_Destroy_By_Administrator implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        $excel = Session::get('excel_borrow_room_destroy_by_administrator');
        // dd($excel);
        $report[] = array(
            'STT',
            'Người mượn',
